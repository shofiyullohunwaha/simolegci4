    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                ...
                <h5 class="text-white op-7 mb-2">Pengelolaan Data Menu</h5>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-3 jedaobyek">
                        <label>Icon*</label>
                        <select class="form-control formt" id="cboicon"
                            onchange="previewicon('cboicon','blokicon')"></select>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-3 jedaobyek">
                        <label>Icon*</label>
                        <select class="form-control forme" id="cboicone"
                            onchange="previewicon('cboicone','blokicone')"></select>
                    </div>
