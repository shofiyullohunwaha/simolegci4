<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h2 class="text-white pb-2 fw-bold">KABUPATEN</h2>
                <h5 class="text-white op-7 mb-2">Pengelolaan Data KABUPATEN</h5>
            </div>
                        ...
                        <table id="tbl-xdt" class="display table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 70%;">Nama Kabupaten</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
<div id="modalupdate" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Update KABUPATEN</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-6 jedaobyek">
...
function filterin(el) {
    ...
    if (id_kab == "") {
        swal({
            title: "Gagal",
            text: "ID KABUPATEN Tidak Terdeteksi",
            icon: "error"
        });
        return;
    }
