<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h2 class="text-white pb-2 fw-bold">jenis uttp</h2>
                <h5 class="text-white op-7 mb-2">Pengelolaan Data jenis uttp</h5>
            </div>
                        ...
                        <table id="tbl-xdt" class="display table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 60%;">Nama uttp</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Tambah jenis uttp</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-6 jedaobyek">
                        <label>Satuan*</label>
                        <select class="form-control forme select2" id="txtsatuan" style="width: 100%;">
                            <option value=''>Pilih Salah Satu</option>
                            <option value='Kg'>gram kilo</option>
                            <option value='M'>meter</option>
                            <option value='N'>Nosel</option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-6 jedaobyek">
                        <label>ID*</label>
                        <input type="text" class="form-control formt khusus_angka" id="txtide"
                            placeholder="Masukkan ID " maxlength="5" readonly autocomplete="off">
                    </div>
                    <div class="form-group col-6 jedaobyek">
                        <label>Nama Uttp *</label>
                    ...
                    <div class="form-group col-6 jedaobyek">
                        <label>Satuan*</label>
                        <select class="form-control forme select2" id="txtsatuane" style="width: 100%;">
                            <option value=''>Pilih Salah Satu</option>
...
function reset() {
    $(".formt").val("");
    $("#txtnama").val("").change();
    $("#txtsatuan").val("").change();
}

function tambah() {
    $("#btnbatal").attr("disabled", true);
    $("#btntambah").attr("disabled", true);
    let id_jenis = $("#txtid").val();
...
function update() {
    ...
    let id_jenis = $("#txtide").val();
    let nama = $("#txtnamae").val();
    let satuan = $("#txtsatuane").val();
    if (nama == "" || satuan == "") {
        swal({
            title: 'Gagal',
            text: 'Ada Isian yang Masih Kosong !',
    ...
    $.ajax({
        ...
        success: function(respon) {
            ...
            if (data.kode == "01") {
                ...
                $("#txtsatuane").val(data.satuan);
                // $("#txtlevele").val(data.id_level).change();
                $("#modalupdate").modal({
                    backdrop: "static",
                    keyboard: false
                });
