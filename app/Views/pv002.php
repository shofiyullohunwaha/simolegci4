<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h2 class="text-white pb-2 fw-bold">PROVINSI</h2>
                <h5 class="text-white op-7 mb-2">Pengelolaan Data PROVINSI</h5>
            </div>
...
<div id="modalupdate" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Update provinsi</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-6 jedaobyek">
...
function hapus(el) {
    let id_provinsi = $(el).data("id_provinsi");
    if (id_provinsi == "") {
        swal({
            title: "Gagal",
...
function filterin(el) {
    ...
    if (id_provinsi == "") {
        swal({
            title: "Gagal",
            text: "ID provinsi Tidak Terdeteksi",
            icon: "error"
        });
        return;
    }
