<div class="panel-header bg-primary-gradient">
	<div class="page-inner py-5">
		<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
			<div>
				<h2 class="text-white pb-2 fw-bold">Kode Akses</h2>
				<h5 class="text-white op-7 mb-2">Pengelolaan Data Kode Akses</h5>
			</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Form Tambah Kode Akses</h4>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="form-group col-4 jedaobyek">
						<label>ID Akses*</label>
						<input type="text" class="form-control formt khusus_angka" id="txtid" placeholder="Masukkan ID Akses" maxlength="3" autocomplete="off">
					</div>
					<div class="form-group col-8 jedaobyek">
						<label>Deskripsi Akses*</label>
						<input type="text" class="form-control formt khusus_abjad" id="txtnama" placeholder="Masukkan Deskripsi Kode Akses" autocomplete="off">
					</div>
				</div>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="form-group col-4 jedaobyek">
						<label>ID Akses*</label>
						<input type="text" class="form-control forme khusus_angka" id="txtide" placeholder="Masukkan ID Akses" maxlength="3" readonly autocomplete="off">
					</div>
					<div class="form-group col-8 jedaobyek">
						<label>Deskripsi Akses*</label>
						<input type="text" class="form-control forme khusus_abjad" id="txtnamae" placeholder="Masukkan Deskripsi Akses" autocomplete="off">
					</div>
				</div>
			</div>
			<div class="modal-footer">
...
<script>
	...
	function hapus(el){
		let id = $(el).data("id");
		if(id == ""){
			swal({title: "Gagal", text: "ID Akses Tidak Terdeteksi", icon: "error"});
			return;
		}
		swal({
			title: 'Hapus Data',
